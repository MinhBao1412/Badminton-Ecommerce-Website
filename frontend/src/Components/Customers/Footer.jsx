            ...
            <Row className='mt-3 mb-3 g-3'>
                ...
                <div className='col-md-4'>
                    ...
                    <p className='fw-bold text-start '>Phone:
                        <Link to={'/'} className='text-primary mx-4' > 0838128780 </Link>
                    </p>
                    <p className='fw-bold text-start'>Email:
                        <Link to={'/'} className='text-primary mx-4' > Baob1910617@student.ctu.edu.vn </Link>
                    </p>
                </div>
            </Row>
            <Row className='mt-2 mb-3'>
                <div className='bg-light' style={{ height: "50px" }}>
                    <p className='d-flex p-2 bd-highlight justify-content-center'>Copyright © 2024 Design by Minh Bao</p>
                </div>
            </Row>
        </div>
    );
