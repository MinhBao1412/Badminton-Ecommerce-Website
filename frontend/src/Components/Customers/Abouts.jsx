    ...
    return (
        <div>
            <div className='d-flex justify-content-center padding-header' style={{ backgroundImage: `url('/image/Background/bg-contacts.png')`, backgroundSize: "cover", height: "500px" }}>
                <div>
                    <h2 style={{ fontSize: "65px", textTransform: "uppercase", color: "#f33f3f", letterSpacing: "5px", fontWeight: "500" }}>BADMINTON STORE</h2>
            ...
            <Container>
                ...
                <Row className='text-start '>
                    <h3>1. BADMINTON STORE</h3>
                    <p>
                        Welcome to Badminton Store! We are your trusted destination for all things related to pet care and the well-being of your beloved pets. Let's dive into who we are and the vision behind our store.
                    </p>
                    <h3>2. Who Are We?</h3>
                    <p>
                        At Badminton Store we are a team of dedicated pet lovers with a mission to provide perfect solutions for all your pet's needs. We understand that pets are not just family members; they are adorable companions. That's why we focus on offering the best products and services to ensure your pets live a healthy and happy life.
                    </p>
                    <h3>3. Our Vision </h3>
                    <p>
                        Our vision at Badminton Store is simple yet powerful: To create a strong and reliable community of pet enthusiasts. We aim to become the top destination for pet lovers where they can find everything their pets need for a joyful and healthy life.
                    </p>
                    ...
                    <h3>5. Why Choose Badminton Store</h3>
                    <p>
                        We are not just a pet supply and care store; we are a passionate pet community. When you choose Badminton Store, you can expect:
                        ...
                        <p style={{ marginLeft: "40px" }}><b>3. Pet-Loving Community: </b>At Badminton Store, you'll find a lovely pet community where you can share experiences and receive support from fellow pet enthusiasts.</p>
                    ...
                    <h3>6. Thank you</h3>
                    <p>
                        Thank you for visiting Badminton Store XYZ. We hope you will find everything you need to take care of your beloved pets here. Feel free to contact us with any questions or requests. We are <Link className="text-primary fw-bold text-center" to={`/contact`}>here</Link> to assist you.
                    </p>
                </Row>
            </Container>
        </div>
