            ...
            <Row>
                <Col md={6}>
                    ...
                    <p className='px-3' style={{ color: 'hsl(218, 81%, 85%)' }}>
                        BADMINTON STORE was founded on December 25, 2023.
                        The project was thought and invented by student Minh Bao and has an estimated completion time of about 4 months.
                        During the research and development process, there are always some difficult problems in terms of knowledge and skills. But it is expected to be completed on May 3, 2023.
                    </p>
                </Col>
                ...
                <Col md='6' className='position-relative'>
                    <div className='container'>
                        ...
                        <div>
                            <img src='/image/Logo/icon-1.jpg' alt='...' style={{ maxWidth: "150px" }} />
                        </div>
